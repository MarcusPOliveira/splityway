    ...
    return (
      <Card>
        <CardContent className="pt-6">
          <p className="text-center text-muted-foreground">Nenhum grupo finalizado ainda</p>
        </CardContent>
      </Card>
    )
  }
            ...
            <CardContent className="space-y-3">
              ...
              <AnimatePresence>
                {isExpanded && (
                      ...
                      {group.items.map((item) => (
                        <div key={item.id} className="text-sm">
                          ...
                          <div className="text-xs text-muted-foreground">
                            {item.quantity} × {formatCurrency(item.totalValue / item.quantity)} · Para:{" "}
                  ...
                  <div>
                    <h4 className="font-semibold text-sm mb-2">Divisão por Pessoa</h4>
                    <div className="space-y-2">
                      {personTotals.map((personTotal) => (
                        <div key={personTotal.person} className="text-sm">
                          <div className="flex justify-between items-center">
                            <span className="font-medium">{personTotal.person}</span>
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button size="sm" className="flex-1" onClick={() => handleViewResults(group.id)}>
